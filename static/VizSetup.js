...
drawXHairs(width/2,height/2);
  svgContainer.on("mousemove", function() {
    ...
    .attr("r", function(d) { return d.display.z * 4.5 * 2; });
...
function translate(d, i, thisP) {
  // pan that node to the center
  console.log("this translate is: ", d);
  //var x = d.cx.animVal.value, y = d.cy.animVal.value;
  var x = d.x, y = d.y;
