  ...
  class NodeEdit extends Backbone.View
    ...
    renderProfile: (node, nodeDiv, blacklist, propNumber) =>
      ...
      if node.type == "project"
        ...
        $nodeHeader = $("<div class=\"node-profile-title\" data-intro='This node can be edited and linked to other nodes from this view.' data-position='right'><a href='#{node.url}'>#{node.ProjectTitle}</a></div>").appendTo nodeDiv
