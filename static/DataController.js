...
(function() {
  define([], function() {
    ...
    return DataController = (function() {
      ...
      DataController.prototype.nodeAdd = function(node, callback) {
        throw "must implement nodeAdd for your data controller";
      };

      DataController.prototype.nodeDelete = function(node, callback) {
        throw "must implement nodeDelete for your data controller";
      };

      DataController.prototype.nodeEdit = function(oldNode, newNode, callback) {
        throw "must implement nodeEdit for your data controller";
      };

      DataController.prototype.linkAdd = function(link, callback) {
        throw "must implement linkAdd for your data controller";
      };

      DataController.prototype.linkDelete = function(link, callback) {
        throw "must implement linkDelete for your data controller";
      };

      DataController.prototype.linkEdit = function(oldLink, newLink, callback) {
