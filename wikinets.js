...
module.exports = MyApp = (function() {
  function MyApp(graphDb) {
    ...
    app.get('/test', function(request, response) {
      return response.render('test.jade');
    });
    ...
    app.post('/create_rel', function(request, response) {
      var cypherQuery, property, value, _ref;
      ...
      return graphDb.cypher.execute(cypherQuery).then(function(relres) {
        ...
        relIDstart = relres.data[0][0]["self"].lastIndexOf('/') + 1;
        return response.send(relres.data[0][0]["self"].slice(relIDstart));
      }, function(relres) {
        console.log(relres);
        return response.send("error");
      });
    ...
    */
    ...
    app.post('/get_arrow', function(request, response) {
      var cypherQuery;
